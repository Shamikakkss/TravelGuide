<template>
  <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10 space-y-8">
    ...
    <!-- Non-Admin / Guest Notice Card -->
    <div v-if="!currentUser || currentUser.role !== 'admin'" class="p-8 sm:p-12 text-center glass-panel rounded-3xl border border-slate-200 dark:border-slate-800 space-y-4 max-w-lg mx-auto">
      <span class="text-4xl">🛡️</span>
      <h3 class="text-xl font-bold text-slate-900 dark:text-white">Administrator Access Required</h3>
      <p class="text-xs text-slate-500 leading-relaxed">
        This portal is restricted to platform administrators to moderate submissions, review quality, and manage listings.
      </p>
    ...
    <!-- Admin Dashboard Container (When Admin) -->
...
const { submissions, places, stays, reviews, approveSubmission, rejectSubmission, currentUser, quickDemoLogin } = useTravelData()
